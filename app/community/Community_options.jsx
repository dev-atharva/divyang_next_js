  ...
  return (
    <>
     ...
     border-gray-700 shadow-md shadow-purple-950 rounded-lg min-w-[12vw] h-auto "
        >
          <div className="flex items-center justify-center gap-2 text-black font-semibold text-lg   pt-1">
            Communities
          </div>
          ...
          {community_options.map((community, index) => (
            <div
              key={index}
              className="flex items-center  px-4 py-1 text-md font-medium text-gray-700"
            >
              {community}
            </div>
          ))}
