...
const Blog_card = ({ title, type, caption, body, author, image_url }) => {
  return (
    <div className="flex flex-col min-w-[20rem] min-h-[23rem] p-2 border-black border-2 space-y-2 rounded-lg shadow-md shadow-purple-950">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="text-black font-bold text-lg mt-2">{title}</div>
